...
// TeamCard Component
const TeamCard = ({ img, name, role, socialLinks, content }) => {
  return (
    <div className="group bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-xl transform hover:-translate-y-2 transition-all duration-300 w-full max-w-sm">
  ...
  const teamMembers = [
    {
      ...
      socialLinks: {
        linkedin:
          "https://www.linkedin.com/in/satyam-kumar-kesarwani-763b61293?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
        github: "https://github.com/satyamkes",
        email: "satyamkesarwani2020@gmail.com",
      },
      content: "Always push yourself!"
    },
    {
      name: "Nikunj Chauhan",
      ...
      socialLinks: {
        linkedin:
          "https://www.linkedin.com/in/nikunj-chauhan-9781832b2?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
        github: "https://github.com/nkca122",
        email: "nkca122@gmail.com",
        
        
      },
      content: "Daily efforts create long-term success."
    },
    {
      ...
      socialLinks: {
        linkedin:
          "https://www.linkedin.com/in/sayanjyotidas?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
        github: "https://github.com/sayanjyotidas",
        email: "sayan@example.com",
        
      },
      content: "Coding is my cardio—just look at my heatmap!"
    },
    {
      name: "Sakina Khan",
      role: "Lead Designer",
      ...
      socialLinks: {
        linkedin:
          "https://www.linkedin.com/in/sakina-khan-a03968278?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
        github: "https://github.com/sakina_khan",
        email: "sakina@!example.com",
        
      },
      content: "Your contribution graph is the mirror of your dedication."
    },
    {
      ...
      socialLinks: {
        linkedin:
          "https://www.linkedin.com/in/sarafaraj-nasardi-7722b31b3?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
        github: "https://github.com/sarafarajnasardi",
        email: "sarafaraj@example.com",
        
      },
      content: "One commit at a time, one step closer to mastery."
    },
  ];
        ...
        <div className="text-center relative z-10 mb-24">
          ...
          <div className="mt-8 max-w-2xl mx-auto space-y-6">
            ...
            <p className="mt-6 text-lg text-gray-600">
              ...
              the best progress tracking experience. Each member brings unique
              expertise and passion to make Traillio exceptional.
            </p>
          </div>
        </div>
        {/*grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 relative place-items-center items-center justify-items-center w-full*/}
        <div className="grid grid-cols-[repeat(auto-fit,_minmax(300px,_1fr))] gap-2 w-full justify-center">
